...
const detiles = () => {
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex items-center text-sm mb-4">
                                    ...
                                    <span className="ml-1">{detile.average_rating} ({detile.total_ratings} reviews)</span>
                                </div>
                            </div>
  ...
  <div className="flex items-center justify-between mb-6">
    ...
    <div className="flex items-center bg-yellow-50 px-3 py-1 rounded-full">
      ...
      <span className="ml-1 font-medium">{detile.average_rating} <span className="text-gray-500 font-normal">({detile.total_ratings} reviews)</span></span>
    </div>
  </div>
