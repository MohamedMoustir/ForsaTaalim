...
const DashboardNav = ({ id_ }) => {
  ...
  return (
    <>
      ...
      <div
        className={`w-[355px] lg:w-64 bg-slate-900 text-white flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-[80%]'} transition-transform duration-300 md:translate-x-0 md:block`}
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <nav className="px-2 space-y-1">
            <a
              ...
              className={`cursor-pointer ${id_ == 1 ? 'text-red-400' : ''} flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800`}
            >
            ...
            <a
              ...
              className={`cursor-pointer ${id_ == 2 ? 'text-red-400' : ''} flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800`}
            >
            ...
            <a
              ...
              className={`cursor-pointer ${id_ == 3 ? 'text-red-400' : ''} flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800`}
            >
            ...
            <a
              id="4"
              onClick={(e) => {
                navigate('/Chat/null/room/null');
                setid(e.target.id);
              }}
              className={`cursor-pointer ${id_ == 4 ? 'text-red-400' : ''} flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800`}
            >
            ...
            <a
              ...
              className={`cursor-pointer ${id_ == 5 ? 'text-red-400' : ''} flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800`}
            >
            ...
            <a
              ...
              className="cursor-pointer flex items-center px-4 py-3 text-sm rounded-md hover:bg-slate-800"
            >
        ...
        <div className="p-4 border-t border-gray-700 flex items-center justify-between">
          ...
          <button className="text-gray-400 hover:text-white md:hidden" onClick={toggleSidebar}>
