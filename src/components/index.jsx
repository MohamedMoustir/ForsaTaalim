...
const index = () => {
    ...
    return (
        ...
        <div className="flex gap-4 items-center ">
            <a href="#"
                className="bg-red-400 border border-red-400 text-white px-[10px] py-[10px] rounded-full hover:bg-red-400 rounded-full text-1xl">M</a>
        </div>
        <button data-collapse-toggle="navbar-hamburger" type="button"
            className="inline-flex items-center justify-center p-2 w-12 h-12 text-sm text-gray-500 rounded-lg  absolute right-[180px] "
        ...
        <ul className="menu hidden flex flex-col font-medium mt-4 w-[200px]  bg-white shadow-sm dark:bg-red-400 dark:border-red-400 text-center absolute right-[8%] bottom-[65%]"
            style="z-index: 1;">
            <li>
                <a href="#" className="block py-2 px-3 text-white bg-red-400  dark:bg-blue-600" aria-current="page">Sort
                    bye</a>
            </li>
            <li>
                <a href="#"
                    className="block py-2 px-3 text-gray-900  hover:bg-red-50 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                    id="p1">Priority</a>
            </li>
            <li>
                <a href="#"
                    className="block py-2 px-3 text-gray-900  hover:bg-red-50 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white"
        ...
        <button className="absolute top-4 right-[225px] p-1 rounded-full bg-white/80 hover:bg-white">
            <svg className="w-8 h-8 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path
                ...
                <div className="flex flex-col md:flex-row items-center justify-around gap-20 p-16">
                    ...
                    <div className="md:w-1/2 relative ">
                        <div className="rounded-lg p-6 relative">
                            <img src="../image/image 15.png" alt="Instructor"
                                ...
                                <div className="flex items-center gap-2 ">
                                    <div className="relative w-[200px] h-16 -top-10">
                                        <svg className="w-[200px] h-[122px]" viewBox="0 0 100 100">
                                            <path d="M10,80 A40,40 0 0,1 90,80" stroke="#E6EFFD" stroke-width="20" fill="none">
                                            </path>
                                            <path d="M10,80 A40,40 0 0,1 90,80" stroke="#EC4899" stroke-width="20" fill="none"
                                                stroke-dasharray="126" stroke-dashoffset="16" transform="rotate(-1, 50, 50)">
                                            </path>
                    ...
                    <section className="bg-gray-50">
                        <div className="max-w-6xl mx-auto p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="relative h-48 bg-gray-200">
                                        <img src="../image/Mask Group.png" alt=""
                                            className="w-[100%] h-[100%] bg-cover  cursor-pointer  cursor-pointer " />
                                    ...
                                    <div className="p-4">
                                        <h2 className="text-xl font-semibold mb-1">Davayne</h2>
                                        <p className="text-sm text-gray-600 mb-3">Baltimore (webcam)</p>
                                        <div className="flex items-center mb-3">
                                            <div className="flex items-center">
                                                <span className="text-yellow-400">★</span>
                                                <span className="ml-1">5</span>
                                                <span className="text-gray-500 text-sm ml-1">(104 reviews)</span>
                                            </div>
                                            <span className="ml-4 text-blue-600 text-sm">Ambassador</span>
                                        </div>
                                        <p className="text-gray-700 text-sm mb-4">Expert online math tutor - personalized, engaging lessons
                                            by a seasoned educator.</p>
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="relative h-48 bg-gray-200">
                                        <img src="../image/images (8).jpg" alt="" className="w-[100%] h-[100%] bg-cover  cursor-pointer" />
                                        <button className="absolute top-4 right-4 p-1 rounded-full bg-white/80 hover:bg-white">
                                            <svg className="w-5 h-5  text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2">
                                                <path
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div className="relative h-48 bg-gray-200">
                                        <img src="../image/images (8).jpg" alt="" className="w-[100%] h-[100%]" />
                                        <button className="absolute top-4 right-4 p-1 rounded-full bg-white/80 hover:bg-white">
                                            <svg className="w-5 h-5  text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2">
                                                <path
