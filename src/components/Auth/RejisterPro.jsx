        ...
        <div className="min-h-screen ">
            <header className="p-6">
                <div className="text-xl font-bold text-red-400">
                    ForsaTaalim
                    <div data-step="1" className="step w-[12.5%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="2" className="step w-[25%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="3" className="step w-[37.5%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="4" className="step w-[50%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="5" className="step w-[62.5%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="6" className="step w-[75%] h-0.5 bg-red-400 mt-1"></div>
                    <div data-step="7" className="step w-[87.5%] h-0.5 bg-red-400 mt-1"></div>
                </div>
            </header>
            <div data-step="1"
                className="step-content hidden flex-grow flex flex-col md:flex-row items-center justify-center max-w-6xl mx-auto px-6 py-12 gap-12 ">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <div className="flex mb-12">
                        ...
                        <button
                            className="bg-red-400 text-white px-6 py-2 rounded-full hover:bg-red-500 transition">Search</button>
                    </div>

                    <div>
                        <h3 className="text-sm font-medium text-gray-500 mb-4">Most taught subjects</h3>
                        <div className="space-y-3">
                            <div id='Mathematics' onClick={(e) => setSubject(e.target.id)}
                    ...
                    <div className="flex items-center justify-between mt-12">
                        <button
                            className="next-btn px-12 py-3 bg-red-400 text-white rounded-full hover:bg-red-500 transition">Next</button>
                    </div>
                </div>
            </div>
            <div data-step="2"
                ...
                <div className="  w-full md:w-1/2">
                    ...
                    <div className="flex items-center justify-between mt-12">
                        <button className=" prev-btn px-6 py-3 bg-gray-100 rounded-full hover:bg-gray-200 transition">Go
                            back</button>
                        <button
                            className="next-btn px-12 py-3 bg-red-400 text-white rounded-full hover:bg-red-500 transition">Next</button>
            ...
            <div data-step="4"
                className=" step-content hiddenflex-grow flex flex-col md:flex-row items-start justify-center max-w-6xl mx-auto px-6 py-12 gap-12 ">
                <div className="w-full md:w-80 bg-red-50 rounded-3xl p-6">
                    <h2 className="font-bold text-xl mb-4">Good to know</h2>
                    <p className="text-gray-700 mb-4">
            ...
            <div data-step="5"
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 ">
                        <input id="inputSerch" value={place} onChange={(e) => setPlace(e.target.value)} type="text" placeholder="Try &quot;Math&quot;"
                                className="pl-10 w-full py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-1 focus:ring-red-400" />
                            <div id='At your house' onClick={(e) => setPlace(e.target.id)}
                            ...
                            <div  id='You can travel'  onClick={(e) => setPlace(e.target.id)} 
                            ...
                            <div id='Online' onClick={(e) => setPlace(e.target.id)}
            ...
            <div data-step="6"
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <div className=" prev-btn flex items-center justify-between mt-12">
                        <button className="px-6 py-3 bg-gray-100 rounded-full hover:bg-gray-200 transition">Go
                            back</button>
                        <button
                            className="next-btn px-12 py-3 bg-red-400 text-white rounded-full hover:bg-red-500 transition">Next</button>
            ...
            <div data-step="7"
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <div className="space-y-4 mb-12 ml-16">
                        <div className="flex">
                            <input type="file"
                                className="hidden flex-grow p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-red-400 mr-2"
                                placeholder="33" />
                            <img src="../../assets/img/image.png" alt="" className="cursor-pointer" />
                        </div>
                        <button className="px-6 py-3 text-white text-center ml-[19%] rounded-full bg-red-400">Upload a
                            video</button>
                    </div>
